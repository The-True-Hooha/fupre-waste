  ...
  return (
    <div className="xl:pt-32 pt-24 relative flex justify-center items-center flex-col">
      <div className="xl:text-5xl text-3xl 2xl:w-3/5 w-3/5 font-medium xl:w-1/3 mx-auto text-center">
        Join us in our pursuit of sustainable innovation and environmental stewardship.
      </div>
      ...
      >
        &quot;We are committed to conducting in-depth studies on waste reduction, recycling processes, and the development of eco-friendly materials. &quot;
      </div>
      ...
      <div className="items-center flex justify-center flex-col">
        ...
        <div className=" text-center">
          <div className="text-sm  font-medium pt-4">Dr. Akinyemi</div>
          <div className="text-sm">FUPRE Waste Management</div>
        </div>
      </div>
    </div>
  );
